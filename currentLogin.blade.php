        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select class="form-control js-example-theme-single">
                        <option value="" selected disabled>Select Complainant</option>
                        @foreach ($residents as $row)
                            <option value="{{ $row->id }}">{{ $row->firstname }} @if ($row->middlename == null)
                                @else
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <select class="form-control js-example-theme-multiple" multiple="multiple"
